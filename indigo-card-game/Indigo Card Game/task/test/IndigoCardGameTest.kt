...
class CardGameTest : StageTest<Any>() {
    ...
    fun normalExeTest(): CheckResult {
        ...
        var position =
            checkOutput(outputString.toLowerCase(), 0, "Choose an action (reset, shuffle, get, exit):".toLowerCase())
        ...
        position = checkOutput(
            ...
            0,
            "Card deck is reset.".toLowerCase(),
            "Choose an action (reset, shuffle, get, exit):".toLowerCase()
        )
        ...
        position = checkOutput(
            outputString.toLowerCase(),
            0,
            "Card deck is shuffled.".toLowerCase(),
            "Choose an action (reset, shuffle, get, exit):".toLowerCase()
        )
    ...
    fun InsufficientNumberTest(): CheckResult {
        ...
        position = checkOutput(
            outputString.toLowerCase(),
            0,
            "The remaining cards are insufficient to meet the request.".toLowerCase(),
            "Choose an action (reset, shuffle, get, exit):".toLowerCase()
        )
        if (position == -1) return CheckResult(
            false,
            "Wrong output after input number of cards larger than remaining cards."
        )
    ...
    fun InvalidNumberTest(): CheckResult {
        ...
        position = checkOutput(
            outputString.toLowerCase(),
            0,
            "Invalid number of cards.".toLowerCase(),
            "Choose an action (reset, shuffle, get, exit):".toLowerCase()
        )
